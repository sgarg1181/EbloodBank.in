...
<body>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
        ...
        <ul class="nav navbar-nav" style="font-family: sans-serif;">
            ...
            <li  style="font-size:1.2em; font-family:cursive; font-weight:bold; "><a href="whydonateblood.php">Donate Blood</a></li>
            <li style="font-family:cursive; font-family:cursive; font-size:1.2em; font-weight:bold;"><a href="requestblood.php">Want Blood</a></li>
             <li style="font-family:cursive; font-family:cursive; font-size:1.2em; font-weight:bold;"><a href="bloodtips.php">Blood Tips</a></li>
            <li class="active" style="font-size:1.2em; font-family:cursive; font-weight:bold;"><a>About Us</a></li>
            <li style="font-size:1.2em; font-family:cursive; font-weight:bold;"><a href="contactus.php">Contact Us</a></li>
            </ul>
...
<div class="mySlides fade">
  ...
  <img src="img/sunrise.png" id="slider" style="width:100%">
  <div class="text">Sunrise</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/farm.png" id="slider" style="width:100%">
  <div class="text">Farm</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/beach.png" id="slider" style="width:100%">
...
<center>
<div style="position: relative;top:250px;" class="about-head">
  <div  class="row"  style="display: table;">
          <div class="column" style=" width: 20%; margin: 25px; float: left;">
            <div style="list-style: none;"><img style="width: 200px; height: 120px;"  src="img/sunrise.png">&#160;&#160;
            <p>Name-Shubham Garg</p>
            </div>
        </div>
          <div class="column" style=" width: 20%; float: left; margin: 25px; ">
            <div style="list-style: none;"><img style="width: 200px; height: 120px;"  src="img/sunrise.png">&#160;&#160;</div>
            <p>Name-Sikander Singh</p>
        </div>
          <div class="column" style=" width: 20%; float: left; margin: 25px;">
          ...
          <div class="column" style="width: 20%; float: left;">
            <div style="list-style: none;"><img style="width: 200px;margin:25px; height: 120px;"  src="img/sunrise.png"></div>
            <p>Name-Shreya Thakral</p>
        </div>
    </div>
    </div>
    </center>
