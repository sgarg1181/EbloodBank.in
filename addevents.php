    ...
    <div class="row">
        <div class="col-sm-2 ">
            ...
            <ul id="Side_Menu" class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="Addnewpost.php"><span class="glyphicon glyphicon-list-alt"></span> Add new Event</a></li>
                <li ><a href="Categories.php"><span class="glyphicon glyphicon-tags"></span> Manage Member</a></li>
